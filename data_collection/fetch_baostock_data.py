...
class DataManager:
    ...
    def __init__(
        ...
        forward_adjust_date: str = "2025-01-15",
        max_workers: int = 10,
    ):
    ...
    def _download_stock_data_job(self, code: str, data: pd.Series) -> None:
        ...
        query = bs.query_history_k_data_plus(
            code, fields_str,
            start_date=data["ipoDate"], adjustflag="2" #2
        )
...
if __name__ == "__main__":
    ...
    dm = DataManager(
        ...
        qlib_export_path=f"./data/qlib_export",
        qlib_base_data_path="Your Qlib base data path",
